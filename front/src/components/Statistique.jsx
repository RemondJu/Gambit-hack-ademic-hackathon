  ...
  render() {
    return (
      ...
      <div className="containerStats">
       ...
       <div style={{height: "15px", width: this.state.widthStatsCulture + 'px', backgroundColor:"blue", borderRadius:"10px"}}></div>
       ...
       <div style={{height: "15px", width: this.state.widthStatsHealth + 'px', backgroundColor:"blue", borderRadius:"10px"}}></div>
       ...
       <div style={{height: "15px", width: this.state.widthStatsSport + 'px', backgroundColor:"blue", borderRadius:"10px"}}></div>
       ...
       <div style={{height: "15px", width: this.state.widthStatsEducation + 'px', backgroundColor:"blue", borderRadius:"10px"}}></div>
       ...
       <div style={{height: "15px", width: this.state.widthStatsGastronomy + 'px', backgroundColor:"blue", borderRadius:"10px"}}></div>
