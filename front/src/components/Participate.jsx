    ...
    return (
      <div className="Participate">
        ...
        <div className="Participation">
          ...
          <span>
            Giving financial support : {this.state.participationAmount} €
          </span>
          <br />
          <div class="slider-wrapper">
            <input
              type="range"
              value={this.state.participationAmount}
              min="0"
              max="1000"
              step="10"
              onChange={this.handleParticipationamount}
            />
          </div>
          <button onClick={() => this.handleClickValidate()}>
          ...
          {this.state.showCardTransactionValidate ? (
            <div className="transactionInformation">
              ...
              <div className="row">
                <p>
                  You will finance the project: {this.props.name} of{" "}
                  {this.state.participationAmount}€. Are you sure?
                </p>
              </div>
              <div>
                <button onClick={() => this.handleClickTransactionValidate()}>
                  Validate
                </button>
          ...
          {this.state.showCardTransaction ? (
            <div className="transactionInformation">
              ...
              <div className="row">
                <p>
                  Your payment of {this.state.participationAmount}€ <br />
                  for {this.props.name} was well taken into account.
                </p>
              </div>
              <div className="row">
